/**
 * customer.js – Talisay Hardware Customer Page Logic
...
const PRODUCTS = [
  // Electronics
  {
    ...
    emoji: "🎧",
    description:
      "Premium over-ear wireless headphones with 40-hour battery life, active noise cancellation, and Hi-Res audio certification. Featuring memory foam ear cushions and foldable design for portability. Connect to 2 devices simultaneously via Bluetooth 5.3.",
    tags: ["wireless", "audio", "noise-cancelling"],
  },
  {
    id: 2,
    name: 'UltraBook Pro 14"',
    store: "TechPeak Electronics",
    category: "electronics",
    price: 1299.0,
    ...
    emoji: "💻",
    description:
      'Razor-thin ultrabook powered by the latest 12-core processor with 32GB RAM and 1TB NVMe SSD. The 14" OLED display delivers stunning 2.8K resolution at 120Hz refresh rate. All-day battery with 80W fast charging.',
    tags: ["laptop", "ultrabook", "oled"],
  },
  {
    id: 3,
    ...
    emoji: "⌚",
    description:
      "Advanced health monitoring smartwatch with ECG, SpO2, and continuous glucose monitoring. Bright AMOLED display, 7-day battery, 50m water resistance. Works with iOS and Android.",
    tags: ["smartwatch", "health", "fitness"],
  },
  {
    id: 4,
    name: '4K Gaming Monitor 27"',
    store: "ViewPro Displays",
    category: "electronics",
    price: 549.0,
    originalPrice: 699.0,
    rating: 4.6,
    ...
    emoji: "🖥️",
    description:
      '27" IPS gaming monitor with 4K UHD resolution, 165Hz refresh rate, 1ms response time, and HDR600 support. G-Sync compatible with rich 99% DCI-P3 color coverage for stunning visuals.',
    tags: ["monitor", "gaming", "4k"],
  },
  // Fashion
  {
    id: 5,
    name: "Air Runner Elite Sneakers",
    store: "StrideUp Sports",
    category: "fashion",
    price: 129.99,
    originalPrice: 170.0,
    rating: 4.8,
    ...
    emoji: "👟",
    description:
      "Engineered mesh upper with adaptive fit system. Carbon-fiber plate for explosive energy return. Ideal for road running and gym workouts. Available in 12 colorways.",
  ...
  },
  {
    ...
    emoji: "🎒",
    description:
      'Sleek 22L capacity backpack crafted from water-resistant recycled polyester. Hidden anti-theft pocket, padded 16" laptop sleeve, and USB-A pass-through port. Carry everything in style.',
    tags: ["backpack", "travel", "minimal"],
  },
  {
    id: 7,
    name: "Luxe Leather Sunglasses",
    store: "VisionMood",
    category: "fashion",
    price: 79.99,
    originalPrice: 100.0,
    ...
    emoji: "🕶️",
    description:
      "Handcrafted acetate frames with polarized UV400 lenses. Spring-loaded hinges and custom carry case included. Timeless design that elevates any outfit.",
  ...
  },
  {
    ...
    emoji: "🧥",
    description:
      "Ultra-soft 100% Merino wool hoodie that regulates temperature naturally. Odor-resistant, machine washable, and sustainably sourced. Perfect for year-round wear.",
    tags: ["hoodie", "wool", "sustainable"],
  },
  // Accessories
  {
    id: 9,
    ...
    emoji: "⌚",
    description:
      "Feather-light titanium case with sapphire crystal glass and Swiss quartz movement. Water-resistant to 100m with interchangeable Milanese loop and rubber strap.",
    tags: ["watch", "titanium", "minimalist"],
  },
  {
    id: 10,
    name: "Genuine Leather Wallet",
    store: "Heritage Goods",
    category: "accessories",
    price: 59.99,
    originalPrice: 80.0,
    rating: 4.6,
    ...
    emoji: "💼",
    description:
      "Full-grain vegetable-tanned leather bifold wallet. RFID-blocking technology, 8 card slots, 2 bill compartments. Gets better with age and develops a unique patina.",
  ...
  // Home
  {
    ...
    emoji: "🌬️",
    description:
      "HEPA H13 filter removes 99.97% of particles down to 0.3 microns. Covers 600 sq ft in 30 minutes. Auto mode adjusts fan speed based on real-time AQI. Ultra-quiet at 25dB.",
  ...
  },
  {
    ...
    emoji: "☕",
    description:
      "Hand-thrown ceramic dripper with matching carafe and bamboo serving tray. The gooseneck pour delivers precise control for cafe-quality coffee at home. Dishwasher safe.",
  ...
  // Sports
  {
    ...
    emoji: "🧘",
    description:
      "Non-slip natural rubber yoga mat with alignment lines and microfiber top layer. 6mm cushioning protects joints. Comes with carry strap and includes 30-day guided class access.",
  ...
  },
  {
    ...
    emoji: "🏋️",
    description:
      "Digital jump rope tracks jumps, calories, and workout duration on built-in LED display. Adjustable cable length, 360° ball bearing system, and memory foam handles.",
  ...
  1: [
    {
      ...
      rating: 5,
      date: "May 2026",
      text: "Absolutely love these headphones! The noise cancellation is incredible.",
    },
    {
      name: "Sarah K.",
      rating: 4,
      date: "Apr 2026",
      text: "Great sound quality. Build feels premium but slightly heavy for long sessions.",
    },
    {
      name: "James T.",
      rating: 5,
      date: "Mar 2026",
      text: "Best headphones I've ever owned. 40h battery is not a lie!",
    },
  ],
  2: [
    {
      ...
      rating: 5,
      date: "May 2026",
      text: "Blazing fast, gorgeous display. Worth every penny!",
    },
  ],
  5: [
    {
      ...
      rating: 5,
      date: "May 2026",
      text: "Ran a half-marathon in these. Zero blisters, insane energy return.",
    },
    {
      name: "Lena B.",
      rating: 4,
      date: "Apr 2026",
      text: "Super comfortable. Love the colorways available!",
    },
  ],
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document
    ...
    .addEventListener("click", toggleMobileCart);
});
...
function openProduct(id) {
  ...
  document.getElementById("detail-store").querySelector("span").textContent =
    product.store;
  ...
  document.getElementById("detail-discount-badge").textContent =
    `-${discountPct}% OFF`;
  ...
  document.getElementById("detail-thumb-img") &&
    (document.getElementById("detail-thumb-img").style.display = "none");
  const thumbEl = document.getElementById("detail-img-thumb");
  if (thumbEl)
    thumbEl.innerHTML = `<div class="w-full h-full flex items-center justify-center text-2xl">${product.emoji}</div>`;
  ...
  // Stars
  document.getElementById("detail-stars").innerHTML = renderStarsHTML(
    product.rating,
  );
...
function addCurrentToCart() {
  ...
  showToast(
    `${detailQty}× ${currentProduct.name} added to cart`,
    "cart-shopping",
  );
}
...
function submitReview() {
  ...
  if (!text) {
    showToast("Please write a review first", "triangle-exclamation", true);
    return;
  }
  if (!currentProduct) return;
...
function renderCartItems(listEl, emptyEl) {
  ...
  cart.forEach((item) => {
    ...
    el.className =
      "cart-item flex items-center gap-3 rounded-xl p-2.5 border border-border animate-fade-in";
...
function updateCartUI() {
  ...
  const deliveryText = cart.length
    ? shipping === 0
      ? "Free (Est. 2–4 days)"
      : "Est. 3–5 days"
    : "—";
  ...
  setTextContent(
    "shipping-cost",
    shipping === 0 && cart.length ? "FREE" : `$${shipping.toFixed(2)}`,
  );
  ...
  renderCartItems(
    ...
    document.getElementById("mobile-cart-empty"),
  );
...
function updateDetailCart() {
  ...
  renderCartItems(
    document.getElementById("d-cart-items"),
    document.getElementById("d-cart-empty"),
  );
...
function applyMobileCoupon() {
  applyCouponCode(document.getElementById("m-coupon-input").value);
}
function applyDetailCoupon() {
  applyCouponCode(document.getElementById("d-coupon-input").value);
}
